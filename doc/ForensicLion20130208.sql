...
-- Records of function
-- ----------------------------
INSERT INTO `function` VALUES ('1', null, null);
...
CREATE TABLE `user` (
  ...
  `jobtitle` varchar(60) NOT NULL COMMENT '职称',
  ...
  `status` int(11) NOT NULL DEFAULT '1' COMMENT '状态 1为有效 0 为锁定',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'kiven', '1234', '123', 'aaa', '123', null, null, '2013-02-08 16:21:46', '2013-02-08 16:21:46', '1');
